...
Dict::Add('FR FR', 'French', 'Français', array(
  ...
  'Class:OSVersion/Attribute:latest_release' => 'Version la plus récente de cette branche',
  'Class:OSVersion/Attribute:date_latest_release' => 'Date de sortie de la version la plus récente',
  'Class:OSVersion/Attribute:date_end_custom_support' => 'Date de fin de support définie par l\'entreprise',
  'Class:OSVersion/Attribute:date_end_custom_support+' => 'Dans certains cas, la date de fin de vie retenue par l\'entreprise est différente de la date de fin de vie officielle. Si ce champ n\'est pas renseigné, la date de fin de vie officielle est retenue.',
	'Class:OSVersion/Attribute:date_effective_eol' => 'Date effective de fin de vie',
  ...
  'Class:Software/Attribute:date_end_custom_support' => 'Date de fin de support définie par l\'entreprise',
  'Class:Software/Attribute:date_end_custom_support+' => 'Dans certains cas, la date de fin de vie retenue par l\'entreprise est différente de la date de fin de vie officielle. Si ce champ n\'est pas renseigné, la date de fin de vie officielle est retenue.',
	'Class:Software/Attribute:date_effective_eol' => 'Date effective de fin de vie',
  ...
  'Class:Software/Attribute:endoflife_api+' => 'Positionnez cette URL pour chercher les dates officielles directement depuis \'endoflife.date\'. l\'URL devrait être sous la  forme \'https://endoflife.date/api/product/cycle.json\'',
	// Common attributes to localize date duration
